...
class Encoder_res101(nn.Module):
    def __init__(self, C):
        ...
        # self.input_dropout = nn.Dropout2d(p=input_dropout_rate)
...
class FeatureRectifyModule(nn.Module):
    def __init__(self, dim, reduction=1, lambda_c=.5, lambda_1=.5):
        ...
        self.cba = CBAM(dim=dim, reduction=1)
...
class Segnet(nn.Module):
    def __init__(self, Z, Y, X, vox_util=None,
        ...
        self.frm1 = FeatureRectifyModule(dim=128, reduction=1, lambda_c=0.5, lambda_1=0.5)
        self.ffm1 = FFM(128, 128)
        self.frm2 = FeatureRectifyModule(dim=128, reduction=1, lambda_c=0.5, lambda_1=0.5)
        self.ffm2 = FFM(128, 128)
        self.cma = CMA(in_channels=128)
